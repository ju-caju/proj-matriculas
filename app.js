...
function renderCalendar(preview){
 ...
 $('#plan-title').textContent='Minha semana · '+semester;$('#plan-count').textContent=S.counts(selected);$('#clear-plan').disabled=!selected.length;$('#export-plan').disabled=!selected.length;
